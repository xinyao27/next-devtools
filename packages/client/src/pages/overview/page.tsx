  ...
  return (
    <div className="h-full p-4">
      ...
      <section className="flex flex-col justify-center space-x-4 py-16 md:flex-row">
        <a href="https://github.com/xinyao27/next-devtools" target="_black">
          <Button className="w-full font-normal" variant="ghost">
            <i className="i-ri-star-line mr-2 size-4" />
            Star on Github
          </Button>
        </a>
        <a href="https://github.com/xinyao27/next-devtools/discussions/15" target="_black">
          <Button className="w-full font-normal" variant="ghost">
            <i className="i-ri-lightbulb-flash-line mr-2 size-4" />
            Ideas & Suggestions
          </Button>
        </a>
        <a href="https://github.com/xinyao27/next-devtools/issues/new/choose" target="_black">
          <Button className="w-full font-normal" variant="ghost">
